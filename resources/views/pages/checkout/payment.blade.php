...
<section id="cart_items">
		...
		<div class="breadcrumbs">
						...
						<tr>
							...
							<td class="cart_quantity">
								<div class="cart_quantity_button">
									...
									<input type="submit" value="Cập nhật" name="update_qty" class="btn btn-defautl btn-sm">
									</form>
								</div>
							</td>
							<td class="cart_total">
			...
			<h3 style="margin: 40px 0;font-size: 20px;">Chọn hình thức thanh toán</h3>
            ...
            <div class="payment-options">
					...
					<span>
						<label><input name="payment_option" value="3" type="checkbox"> Thanh toán momo</label>
					</span>
