                    ...
                    <div class="category-tab shop-details-tab"><!--category-tab-->
						...
						<div class="tab-content">
							...
							<div class="tab-pane fade " id="reviews" >
								<div class="col-sm-12">
									<ul>
										<li><a href=""><i class="fa fa-user"></i>TP Hồ Chí Minh</a></li>
										<li><a href=""><i class="fa fa-clock-o"></i>12:41</a></li>
										<li><a href=""><i class="fa fa-calendar-o"></i>14-11-2023</a></li>
									</ul>
									<p>Hãy cho tôi biết bạn nghĩ gì về sản phẩm chúng tôi</p>
									<p><b>Gửi tin nhắn cho chúng tôi tại đây</b></p>
